...
import { name, description, styles as wizardStyles } from '../design/styles';
...
export const CreateTestModal: React.FC<CreateTestModalProps> = props => {
  ...
  return (
    <DialogWrapper
      isOpen={isOpen}
      onDismiss={onDismiss}
      {...DialogCreationCopy.DEFINE_TEST_OBJECTIVE}
